 ...
 * variant: 'primary' (institucional) | 'secondary' (contacto)
 *
 * @package TailPress
 */
...
<section class="py-6 bg-gradient-to-r from-alderetes-orange via-alderetes-orange to-alderetes-green relative overflow-hidden">
...
<section class="py-12 bg-gradient-to-r from-alderetes-green to-alderetes-blue relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            <div class="flex items-center gap-4">
                ...
                <div class="text-white">
                    ...
                    <p class="font-bold text-lg">Sin teléfono publicado</p>
                </div>
            </div>
            <div class="flex items-center gap-4">
                <div class="p-3 bg-white/20 rounded-xl">
