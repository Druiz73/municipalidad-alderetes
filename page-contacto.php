            ...
            <div class="space-y-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100">
                        <div class="p-3 bg-alderetes-cream rounded-xl flex-shrink-0">
                    ...
                    <div id="form-container">
                        ...
                        <form id="contacto-form" class="space-y-6" novalidate>
                            ...
                            <button type="submit" id="submit-btn"
                                class="w-full h-12 bg-alderetes-orange hover:bg-[#a95c1e] text-white font-semibold rounded-xl transition-colors flex items-center justify-center gap-2">
...
(function () {
    ...
    errorDiv.className = 'hidden p-4 mb-6 text-sm text-red-700 bg-red-100 rounded-lg';
    ...
    form.addEventListener('submit', function (e) {
        ...
        formData.append('action', 'submit_contacto_form');
        ...
        .then(data => {
            if (data.success) {
                ...
                throw new Error(data.data || 'Ocurrió un error al enviar el mensaje.');
            }
        })
        .catch(error => {
            errorDiv.textContent = error.message || 'Error de conexión. Por favor intentá nuevamente más tarde.';
