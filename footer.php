...
<footer class="bg-gradient-to-b from-[#102744] via-[#14335d] to-[#0b1d34] text-white">
    <div class="max-w-7xl mx-auto px-4 py-10 md:py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.15fr_1.4fr_1fr] gap-8 lg:gap-12">
            ...
            <div class="space-y-5 md:order-1">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="https://www.instagram.com/municipalidaddealderetes/" target="_blank" rel="noopener noreferrer" class="w-11 h-11 bg-white/10 hover:bg-alderetes-orange rounded-xl flex items-center justify-center transition-colors" aria-label="Instagram Municipalidad de Alderetes">
            ...
            <div class="md:order-3 md:col-span-2 lg:order-2 lg:col-span-1">
                ...
                <nav class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-2" aria-label="Áreas del Municipio">
                    ...
                    <a href="<?php echo esc_url(home_url('/deporte')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Deporte</a>
                    <a href="<?php echo esc_url(home_url('/educacion')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Educación y Cultura</a>
                    <a href="<?php echo esc_url(home_url('/obras-publicas')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Obras Públicas</a>
                    <a href="<?php echo esc_url(home_url('/punto-digital')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Punto Digital</a>
                    <a href="<?php echo esc_url(home_url('/rentas')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Rentas</a>
                    <a href="<?php echo esc_url(home_url('/oficina-empleo')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Oficina de Empleo</a>
                    <a href="<?php echo esc_url(home_url('/seguridad')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Seguridad</a>
                    <a href="<?php echo esc_url(home_url('/transito')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm">Tránsito</a>
                    <a href="<?php echo esc_url(home_url('/tribunal-de-faltas')); ?>" class="rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-2.5 text-gray-200 hover:text-alderetes-gold transition-colors text-sm sm:col-span-2 md:col-span-1">Tribunal de Faltas</a>
                </nav>
            </div>
