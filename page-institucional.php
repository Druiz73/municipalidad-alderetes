...
<section class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4">
        <div class="prose prose-lg max-w-none text-gray-700">
            <h2 class="text-3xl font-bold text-gray-900 mb-8 border-l-4 border-alderetes-orange pl-4 uppercase">Institucional</h2>
...
<section class="py-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
    <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="text-center mb-16">
            <span class="inline-block text-alderetes-orange text-sm font-semibold tracking-widest uppercase mb-3">Nuestras raíces</span>
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Historia de Alderetes</h2>
            ...
            <p class="text-gray-500 max-w-2xl mx-auto text-lg leading-relaxed">
                Ubicada en el departamento Cruz Alta, a solo 7 kilómetros de San Miguel de Tucumán, Alderetes es una de las ciudades más jóvenes y vibrantes de la provincia.
            </p>
        </div>
        ...
        <div class="relative">
            ...
            <div class="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-0 mb-16 group">
                <div class="md:w-1/2 md:pr-16 md:text-right order-2 md:order-1">
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
                        <span class="inline-block bg-alderetes-blue/10 text-alderetes-blue text-xs font-bold px-3 py-1 rounded-full mb-3 tracking-wide">Fines del Siglo XVIII</span>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">La Posta Colonial</h3>
                        <p class="text-gray-600 leading-relaxed text-sm">
                            La historia de Alderetes se remonta a fines del siglo XVIII, cuando funcionaba como una <strong>posta en el antiguo camino al norte</strong> durante la etapa colonial, en una zona estratégica cercana al río Salí.
                        </p>
                    </div>
                </div>
                <!-- Ícono central -->
            ...
            <div class="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-0 mb-16 group">
                <div class="md:w-1/2 md:pr-16 md:text-right order-2 md:order-1">
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
                        <span class="inline-block bg-alderetes-blue/10 text-alderetes-blue text-xs font-bold px-3 py-1 rounded-full mb-3 tracking-wide">Comienzos del Siglo XX</span>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Auge Agrícola e Inmigración</h3>
                        <p class="text-gray-600 leading-relaxed text-sm">
                            Su desarrollo estuvo vinculado a la <strong>expansión agrícola y azucarera</strong> de Tucumán. La llegada de inmigrantes aportó diversidad cultural y dinamismo comercial, enriqueciendo la identidad local.
                        </p>
                    </div>
                </div>
                <!-- Ícono central -->
            ...
            <div class="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-0 mb-16 group">
                ...
                <div class="md:w-1/2 md:pl-16 order-2 md:order-3">
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
                        <span class="inline-block bg-alderetes-orange/10 text-alderetes-orange text-xs font-bold px-3 py-1 rounded-full mb-3 tracking-wide">Segunda Mitad del Siglo XX</span>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Conurbanización y Crecimiento Urbano</h3>
                        <p class="text-gray-600 leading-relaxed text-sm">
                            El crecimiento urbano de la capital provincial impulsó un proceso de <strong>conurbanización</strong> que transformó a Alderetes en una ciudad integrada al Gran San Miguel de Tucumán.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-0 mb-16 group">
                <div class="md:w-1/2 md:pr-16 md:text-right order-2 md:order-1">
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100">
                        <span class="inline-block bg-alderetes-blue/10 text-alderetes-blue text-xs font-bold px-3 py-1 rounded-full mb-3 tracking-wide">Mediados de la Década de 1980</span>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Categoría de Municipio</h3>
                        <p class="text-gray-600 leading-relaxed text-sm">
                            Con el retorno de la democracia, Alderetes obtuvo su <strong>categoría de municipio</strong>, consolidando su autonomía y capacidad de gestión para el bienestar de sus habitantes.
                        </p>
                    </div>
                </div>
                <!-- Ícono central -->
            ...
            <div class="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-0 group">
                ...
                <div class="md:w-1/2 md:pl-16 order-2 md:order-3">
                    <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-100 border-l-4 border-l-alderetes-orange">
                        <span class="inline-block bg-alderetes-orange/10 text-alderetes-orange text-xs font-bold px-3 py-1 rounded-full mb-3 tracking-wide">Hoy</span>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Una Ciudad en Crecimiento</h3>
                        <p class="text-gray-600 leading-relaxed text-sm">
                            Alderetes combina su <strong>identidad histórica</strong> con un sostenido crecimiento demográfico y urbano, siendo una comunidad que refleja los procesos sociales, económicos y culturales característicos del este tucumano.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-20 bg-gradient-to-br from-alderetes-blue to-blue-900 rounded-3xl p-10 text-white text-center shadow-2xl">
            ...
            <p class="text-alderetes-orange font-semibold text-sm tracking-widest uppercase mb-2">Ubicación</p>
            <h3 class="text-2xl md:text-3xl font-bold mb-3">Departamento Cruz Alta</h3>
            <p class="text-blue-200 max-w-lg mx-auto">A solo <span class="text-white font-bold text-xl">7 km</span> de San Miguel de Tucumán, en el corazón del este tucumano.</p>
        </div>
